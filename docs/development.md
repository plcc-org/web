...
`patches/@tinacms+cli+2.7.0.patch` (applied by `postinstall`, via `patch-package`) makes
...
it entirely if Tina ever grows a flag for this — there is none as of 2.7.0. This is one of
